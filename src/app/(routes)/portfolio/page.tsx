    ...
    <ContainerPage>
     ...
     {/* <CircleImage/>*/}
          ...
          <div className=" flex flex-col justify-center h-full">
            ...
            <h1 className="text-2xl  leading-tight text-center md:text-4xl md:mb-5"> Mis <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#E0E1DD] via-[#00F2FF] to-[#61DAFB]">Proyectos </span></h1>
